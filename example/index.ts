...
import { RazorWebhook } from "../dist/webhook";
...
rzp.payments
  .capture("pay_6CnVGA5eq4D7Ce", 1000, "INR")
  .then((data) => {
    // success
    console.log(data);
  })
...
rzp.payments
  .orderPayments("order_6kWIxkrdH3hJWM")
  .then((data) => {
    console.log(data);
  })
  .catch((error) => {
...
wh.handler.disputeClosed = (pl) => {
  return Promise.resolve();
};

const execute = wh.execute();
